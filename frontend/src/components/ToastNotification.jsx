...
export default function ToastNotification({ onSelectEvent }) {
  ...
  return (
    <div className="fixed top-5 right-5 z-[10000] max-w-md w-full animate-slide-in pointer-events-auto">
      <div className={`bg-white rounded-3xl border shadow-2xl p-4 transition-all duration-300 ${borderColor}`}>
        <div className="flex items-start justify-between gap-3">
          {/* Severity Icon */}
          <div className="p-2.5 rounded-2xl bg-sky-50 text-sky-700 flex-shrink-0 border border-sky-100">
            {isCritical ? (
          ...
          <div className="flex-1 space-y-1">
            ...
            <div className="flex items-center justify-between text-[11px] text-slate-400 font-mono pt-1">
              ...
              <span>{activeToast.timeAgo || 'Just now'}</span>
            </div>
          </div>
